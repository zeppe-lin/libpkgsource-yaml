...
{
  expect_yaml_error(yaml_error_code::invalid_value, "profiles.yml", "format",
                    [] {
...
{
  expect_yaml_error(yaml_error_code::invalid_type, "profiles.yml", "profiles",
                    [] {
                      (void)parse_profiles_yaml(
...
void rejects_empty_profiles_and_scalar_member_shorthand()
{
  expect_yaml_error(yaml_error_code::invalid_value, "profiles.yml",
                    "profiles.empty", [] {
                      (void)parse_profiles_yaml(
...
int main()
{
  return test_support::run({
      ...
      {"rejects empty profiles and scalar shorthand",
       rejects_empty_profiles_and_scalar_member_shorthand},
  });
}
