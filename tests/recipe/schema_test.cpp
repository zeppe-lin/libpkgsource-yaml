...
void rejects_unknown_keys_and_missing_required_sections()
{
  expect_yaml_error(yaml_error_code::unknown_key, "recipe.yml",
                    "check.program", [] {
...
{
  expect_yaml_error(yaml_error_code::invalid_value, "recipe.yml",
                    "package.release", [] {
                      (void)parse_recipe_yaml(
                          "format: zeppe-lin.recipe/1\n"
                          "package:\n"
...
{
  expect_yaml_error(yaml_error_code::invalid_type, "recipe.yml",
...
void rejects_unknown_lifecycle_actions_and_program_languages()
{
  expect_yaml_error(yaml_error_code::invalid_value, "recipe.yml",
...
int main()
{
  return test_support::run({
      ...
      {"rejects unknown and missing keys",
       rejects_unknown_keys_and_missing_required_sections},
      ...
      {"rejects unknown lifecycle actions and languages",
       rejects_unknown_lifecycle_actions_and_program_languages},
  });
}
